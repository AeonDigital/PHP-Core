...
class tStringTest extends TestCase
{
    ...
    public function test_instance()
    {
        ...
        $this->assertSame("error.obj.value.max.length.exceeded", $obj->getLastSetError());
        $this->assertSame("valid value", $obj->get());

        $this->assertFalse($obj->set("inv"));
        $this->assertSame("error.obj.value.min.length.expected", $obj->getLastSetError());
        $this->assertSame("valid value", $obj->get());
        ...
        $this->assertSame("error.obj.value.not.in.enumerator", $obj->getLastSetError());
        $this->assertSame(null, $obj->get());
