...
use AeonDigital\DataFormat\Patterns\EUA\Dates\DateTime as DateTime;
...
class EUADateTimeTest extends TestCase
{
    ...
    {
        $this->assertTrue(DateTime::check("02/29/2012 12:45:00"));
        ...
        $this->assertFalse(DateTime::check("15-01-2010 12:45:00"));
    }
    ...
    {
        $this->assertSame("05-17-1980 00:00:00", DateTime::format("1980-05-17", ["Y-m-d"]));
        $this->assertSame("05-17-1980 00:00:00", DateTime::format("1980-05-17", ["DateMask" => "Y-m-d"]));
        $this->assertSame(null, DateTime::format("1980-17-05"));
    ...
    public function test_method_removeFormat()
    {
        ...
        $resultDate = DateTime::removeFormat("05-17-1980 05:15:00");
